...
<% String path = request.getContextPath(); response.setHeader("refresh", "5,url="+path+"/controlSubject"); %>
</c:when>
...
<% String path = request.getContextPath(); response.setHeader("refresh", "5,url="+path+"/findStudent"); %>
</c:when>
