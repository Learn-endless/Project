...
<body>
	<form class="form-horizontal" method="post" action="register">
		<div class="form-group">
			<%--@declare id="studentid"--%><label for="studentId" class="col-sm-2 control-label">学生编号:</label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<%--@declare id="studentname"--%><label for="studentName" class="col-sm-2 control-label">学生姓名:</label>
			<div class="col-sm-4">
